...
void chain() {\n
// init
TChain ch(\"T_scint\");\nLong64_t nIBDs(0);TVectorF matchCounts(4);\n\n// file loop\n" > chain.cxx
...
if (matches_job==0) (TVectorF*)matches_job = gFile->FindObjectAny(\"matches_0_1_2_many\");
TVectorF jobMatches = *matches_job;
matchCounts += jobMatches;
"  >> chain.cxx
done
