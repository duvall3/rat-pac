...
# Usage: user@host:$RATROOT/data/<experiment>/.../REF_DISTRIBS$ ref_compare.sh <DIRECTORY> [ANDERSON_TF] [VARNAME]
...
# arg / help check
if [[ ($# -eq 0) || ($1 =~ -h) ]]; then
  echo "Usage: user@host:$RATROOT/data/<experiment>/.../REF_DISTRIBS$ ref_compare.sh <DIRECTORY> [ANDERSON_TF] [VARNAME]"
  exit 10
fi
