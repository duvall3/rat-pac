...
The viewer is a mostly self-contained ROOT macro. It is located on GitHub at *duvall3 --> rat-pac --> branch collab --> user --> root_macros --> [RATPACEventViewer2.cxx](https://github.com/duvall3/rat-pac/blob/collab/user/root_macros/RATPACEventViewer2.cxx) ([file](https://github.com/duvall3/rat-pac/raw/collab/user/root_macros/RATPACEventViewer2.cxx))*.
...
//
// ~ Mark J. Duvall ~ mjduvall@hawaii.edu ~ Written 10/2019 ~ Updated 3/2022 ~ //
