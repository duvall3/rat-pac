...
TDuvallAnalyze::RtToRoot()
{
  ...
  rt_to_root(rtFileName);
}

//______________________________________________________________________________
// ibdTracksToScint
TDuvallAnalyze::ibdTracksToScint()
{
...
////______________________________________________________________________________
//// SEDAQ -- reimplemented from standalone macro
//TDuvallAnalyze::SEDAQ()
//{
//
...
//
//  // re-implement defaults //TEMP
//  Bool_t graphics_tf = kTRUE;
//  Bool_t nulat_tf = kFALSE;
//  Double_t prompt_low = 0.; //MeV
//  Double_t delayed_low = 0.; //MeV
//  Double_t deltaT_low = 1.e-6; //s
//  Double_t deltaT_high = 100.e-6; //s
//
//
//  //#include <math.h>
//
...
//  FileName = TString::Format("%s_T.root", fDatarun);
...
//  TFriendElement* TF = T2->AddFriend("T",FileName.Data());
//  TTree* T = TF->GetTree();
//
//  // address T branches
...
//    h_ibdx->SetTitle("Interevent Time (s)");
//    h_ibdy->SetTitle("Energy (MeV)");
//
...
//    h_prompt->Draw();
//    h_delayed->Draw("same");
////  fHistList->Add(h_prompt);
////  fHistList->Add(h_delayed);
//
//    // save plots
//    c2->Write();
//    c3->Write();
...
TDuvallAnalyze::AngularRecon()
{
  ...
  angularRecon( arFileName.Data(), kTRUE );
}
